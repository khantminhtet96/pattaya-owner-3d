...
2. Add a Social API app.
3. Endpoint URL: `https://pattaya-owner-3d.vercel.app/` (use the exact production URL after deployment).
4. In the Social API tab, enable Share Target Picker and accept the required agreement.
5. Copy the Social API ID.
6. In the owner app: Settings → LINE Report Share → paste Social API ID → Save.
7. Tap Open in LINE.
